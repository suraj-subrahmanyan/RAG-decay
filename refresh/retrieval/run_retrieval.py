"""
Run retrieval on LangChain queries using BM25, BGE, and Fusion methods.

This script retrieves top-k documents for each query from the FreshStack dataset.
Results are saved for evaluation against nugget-level ground truth.

Methods:
- BM25: Sparse lexical retrieval (Pyserini/Lucene)
- BGE: Dense semantic retrieval (BAAI/bge-multilingual-gemma2)
