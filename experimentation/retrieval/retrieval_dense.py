"""
Dense retrieval using BGE or E5 models with FAISS and multiple query fields.
...
Usage:
    ...
    python retrieval_dense.py --config config_retrieval.yaml --model bge --corpus-version oct_2024 --query-fields answer nuggets
"""
...
def get_query_text(query_data: dict, query_field: str) -> tuple:
    ...
    Args:
        ...
        query_field: Field to use (answer, nuggets, closed_book_answer, subquestions)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        default=["answer", "nuggets", "closed_book_answer", "subquestions"],
        choices=["answer", "nuggets", "closed_book_answer", "subquestions"],
